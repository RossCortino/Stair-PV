...
figure
subplot(221)
plot(t, stairVCTrajectories.knee.in20)
hold on
plot(t, knee_20_decvc, '--')
subplot(222)
plot(t, stairVCTrajectories.knee.in25)
hold on
plot(t, knee_25_decvc, '--')
subplot(223)
plot(t, stairVCTrajectories.knee.in30)
hold on
plot(t, knee_30_decvc, '--')
subplot(224)
plot(t, stairVCTrajectories.knee.in35)
hold on
plot(t, knee_35_decvc, '--')

figure
subplot(221)
plot(t, stairVCTrajectories.ankle.in20)
hold on
plot(t, ankle_20_decvc, '--')
subplot(222)
plot(t, stairVCTrajectories.ankle.in25)
hold on
plot(t, ankle_25_decvc, '--')
subplot(223)
plot(t, stairVCTrajectories.ankle.in30)
hold on
plot(t, ankle_30_decvc, '--')
subplot(224)
plot(t, stairVCTrajectories.ankle.in35)
hold on
plot(t, ankle_35_decvc, '--')
...
pa_real25_deccvc = real(fft(ankle_25_decvc)/(L/2));
...
for i = 1:N/2
    ...
    vareal_decvc(i,:) = [pa_real25_deccvc(i) pa_real30_decvc(i) pa_real35_decvc(i)];
...
for i = 1:length(t)
    ...
    if current_min ~= qh_min
        ...
        N_k = 12;
        N_a = 12;
        hk_decvc = .5*interp1(x,vkreal_decvc(1,:),xq,'linear','extrap')+.5*interp1(x,vkreal_decvc(N_k/2+1,:),xq,'linear','extrap')*cos(pi*N_k*sh);
        ha_decvc = .5*interp1(x,vareal_decvc(1,:),xq,'linear','extrap')+.5*interp1(x,vareal_decvc(N_a/2+1,:),xq,'linear','extrap')*cos(pi*N_a*sh);
...
estimatedAngles.knee.(incline{1})  = knee_decvc_est;
estimatedAngles.ankle.(incline{1})  = ankle_decvc_est;
