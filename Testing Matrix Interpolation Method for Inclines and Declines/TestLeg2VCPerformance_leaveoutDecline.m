...
legend([pk2,pk3,pk4],'Able-Bodied','Est(Org Dec and VC interp)','Est(Leg 2 Dec and VC Interp)','Location','Southeast')
grid on
...
legend([pa2,pa3,pa4],'Able-Bodied','Est(Org Dec and VC interp)','Est(Leg 2 Dec and VC Interp)','Location','Southeast')
...
if predeterminedIncline
    ...
    if ascend == 1
        ...
        if min_Index2 == 1
            ...
            b0 = 1-b1;
            %             b
            b(bounds+(length(knownMinima)-length(usefulMinima)-1))= [b1 b0];
            b
            ...
            b0 = 1-b1;
            %             b
            b(bounds+(length(knownMinima)-length(usefulMinima)-1))= [b0 b1];
            b
