...
% figure
% plot(percentGait,thigh_20, percentGait,thigh_25, percentGait,thigh_30, percentGait,thigh_35)
% xlabel("Gaitcycle(%)")
% ylabel("Angle(^{o})")
% legend('20^{o}','25^{o}','30^{o}','35^{o}')
% 
% 
% 
% 
...
% 
% F(repelem(25,150),1:150)
% thigh_25(1)
% figure
% plot(percentGait,thigh_25, percentGait,F(repelem(25,150),1:150))
% xlabel("Gaitcycle(%)")
% ylabel("Angle(^{o})")
% legend('25^{o}','Estimated 25^{o}')
...
ankle_25_est = double(subs(ha, sh, s_h));
figure
