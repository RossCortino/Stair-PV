...
%         end
        ...
        [currPV,currState,sm,qhm] = calculatePhaseVariable_Stair(thigh, thighd, qh_min, qh_max_5,q_po, c, prevState,prevPV, sm, qhm,mhf, pv_swing_thresh);
        %
...
figure
sgtitle('Descent: -30^o')
subplot(311)
plot(gc,thigh_d30,"linewidth",2)
ylabel("Thigh Angle (^o)")
xlabel("Gait Cycle (%)")
xline(60,"k--","linewidth",2)
grid on
subplot(312)
plot(gc,knee_d30,"linewidth",2)
ylabel("Knee Angle (^o)")
xlabel("Gait Cycle (%)")
grid on
xline(60,"k--","linewidth",2)
...
sgtitle('Ascent: 30^o')
subplot(311)
plot(gc,thigh_30,"linewidth",2)
ylabel("Thigh Angle (^o)")
xlabel("Gait Cycle (%)")
xline(60,"k--","linewidth",2)
grid on
subplot(312)
plot(gc,knee_30,"linewidth",2)
ylabel("Knee Angle (^o)")
xlabel("Gait Cycle (%)")
xline(60,"k--","linewidth",2)
grid on
