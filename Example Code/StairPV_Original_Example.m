...
for i = 1:length(t)
    ...
    thighd = thigh_30d_shift(i);
    
    [currPV,currState,sm,qhm,mhf] = calculatePhaseVariable_Stair(thigh, thighd, qh_min, qh_max,s_po, c_shift, prevState,prevPV, sm, qhm,mhf,pv_swing_thresh);
